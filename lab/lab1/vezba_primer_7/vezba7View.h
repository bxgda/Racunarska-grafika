...
// vezba7View.h : interface of the Cvezba7View class
//

#pragma once


class Cvezba7View : public CView
{
protected: // create from serialization only
	Cvezba7View() noexcept;
	DECLARE_DYNCREATE(Cvezba7View)

// Attributes
public:
	Cvezba7Doc* GetDocument() const;
...
#ifndef _DEBUG  // debug version in vezba7View.cpp
inline Cvezba7Doc* Cvezba7View::GetDocument() const
   { return reinterpret_cast<Cvezba7Doc*>(m_pDocument); }
#endif
