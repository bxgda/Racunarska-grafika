...
// vezba5View.h : interface of the Cvezba5View class
//

#pragma once


class Cvezba5View : public CView
{
protected: // create from serialization only
	Cvezba5View() noexcept;
	DECLARE_DYNCREATE(Cvezba5View)

// Attributes
public:
	Cvezba5Doc* GetDocument() const;
...
#ifndef _DEBUG  // debug version in vezba5View.cpp
inline Cvezba5Doc* Cvezba5View::GetDocument() const
   { return reinterpret_cast<Cvezba5Doc*>(m_pDocument); }
#endif
