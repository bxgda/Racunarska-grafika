...
// vezba4View.h : interface of the Cvezba4View class
//

#pragma once


class Cvezba4View : public CView
{
protected: // create from serialization only
	Cvezba4View() noexcept;
	DECLARE_DYNCREATE(Cvezba4View)

// Attributes
public:
	Cvezba4Doc* GetDocument() const;
...
#ifndef _DEBUG  // debug version in vezba4View.cpp
inline Cvezba4Doc* Cvezba4View::GetDocument() const
   { return reinterpret_cast<Cvezba4Doc*>(m_pDocument); }
#endif
