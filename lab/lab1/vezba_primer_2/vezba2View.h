...
// vezba2View.h : interface of the Cvezba2View class
//

#pragma once


class Cvezba2View : public CView
{
protected: // create from serialization only
	Cvezba2View() noexcept;
	DECLARE_DYNCREATE(Cvezba2View)

// Attributes
public:
	Cvezba2Doc* GetDocument() const;
...
#ifndef _DEBUG  // debug version in vezba2View.cpp
inline Cvezba2Doc* Cvezba2View::GetDocument() const
   { return reinterpret_cast<Cvezba2Doc*>(m_pDocument); }
#endif
