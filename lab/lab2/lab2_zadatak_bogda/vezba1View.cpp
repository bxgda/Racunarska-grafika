...
#define SIRINA_KAKTUSA 60	// velicina pojedinacnih delova kaktusa
...
void Cvezba1View::OnDraw(CDC* pDC)
{
	...
	IspisiTekst(pDC, CString("Biljka"), Kockica(19), Kockica(1), -90, -90);
...
void Cvezba1View::DrawFigure(CDC* pDC)
{
	...
	Translate(pDC, Kockica(2.15), Kockica(0.85), false);

	NacrtajDeoKaktusa(pDC, M_PI_2, 0.7f, 1, false);

	Rotate(pDC, ugao2, false);

	NacrtajDeoKaktusa(pDC, 0, 0.7f, 1, true);
	...
	NacrtajDeoKaktusa(pDC, 0, 0.7f, 1, false);
	NacrtajDeoKaktusa(pDC, M_PI_2, 0.7f, 1, false);
	NacrtajCvor(pDC);
